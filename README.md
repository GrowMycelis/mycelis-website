...
- `verdeis.html` — Verdeis product story
...
- No finished Verdeis render or photography has been supplied. Its page uses an intentional type-led, tiered composition and makes no visual claim about final hardware.
